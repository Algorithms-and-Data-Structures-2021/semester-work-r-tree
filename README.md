...
- _Теоретическая сложность операций: поиск O(M), удаление O(M), вставка O(M)._

## Команда softBoys

| Фамилия Имя          | Вклад (%) | Прозвище               |
| :---                 |   ---:    |  ---:                  |
| Герасимов Данил      | 50        |  _босс_                |
| Багаутдинов Даниил   | 0         |  _визуальный директор_ |
| Калугин Артем        | 50        |  _самозванец_          |
